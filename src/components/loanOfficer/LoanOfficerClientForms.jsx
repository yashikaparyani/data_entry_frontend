...
import './LoanOfficerClientForms.css';

const LoanOfficerClientForms = () => {
  ...
  const fetchClientForms = useCallback(async () => {
    try {
      ...
      const response = await axios.get(`/api/loan-officer/clients/${clientId}/forms`, {
        headers: {
  ...
  if (error) {
    return (
      <div className="client-forms-error">
        ...
        <button onClick={() => navigate('/loan-officer/dashboard')} className="back-btn">
          Back to Dashboard
        </button>
      </div>
    );
  ...
  return (
    <div className="loan-officer-client-forms">
      {/* Header */}
              ...
              <div className="header-info">
                ...
                <div className="client-info-header">
                  ...
                  {clientData?.client?.phone && (
                    <p className="client-phone">📞 {clientData.client.phone}</p>
                  )}
                </div>
              </div>
            </div>
...
export default LoanOfficerClientForms;
